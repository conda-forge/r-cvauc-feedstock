...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4217&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-cvauc-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-cvauc` can be installed with `conda`:
...
```
mamba install r-cvauc
```

It is possible to list all of the versions of `r-cvauc` available on your platform with `conda`:
...
```
mamba search r-cvauc --channel conda-forge
```
...
mamba repoquery search r-cvauc --channel conda-forge

# List packages depending on `r-cvauc`:
mamba repoquery whoneeds r-cvauc --channel conda-forge

# List dependencies of `r-cvauc`:
mamba repoquery depends r-cvauc --channel conda-forge
```
